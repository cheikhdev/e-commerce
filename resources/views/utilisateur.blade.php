@extends('layouts.appclient')
    @section('content')
            ...
            <div class="container-fluid">
              <div class="row">
				...
				@foreach($products as $product)
					<div class="col-lg-4 col-md-6 col-12" style="height:200px;width:600px;margin-bottom:20px;">
						<div class="single-banner">
							<a href=""><img class="" style="height:200px;width:600px;" src="{{$product->image_product ? asset($product->image_product) : asset('uploads/images/default.png')}}"    alt=""></a>
								<div class="content">
        ...
        <div class="product-area section">
				...
				<div class="row">
					<div class="col-12">
						<div class="section-title">
							<h2>Affichage des produits par categories</h2>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#women" role="tab">MMaçonnerie</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#kids" role="tab">Peinture</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">Plomberie</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#essential" role="tab">Sanitaire</a></li>
            ...
            @foreach($products as $product)
              <div class="col-6 col-md-4 col-lg-3  portfolio-item" style="margin-bottom:20px;">
