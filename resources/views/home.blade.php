        ...
        <div id="image">
          <div class="text" role="listbox">
            <div class="carousel-item active">
              ...
              <img class="d-block img-fluid" src="{{URL::asset('/images/fibre1.png')}}" alt="First slide" width="900" height="350">
             
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/dronesblanc.jpg')}}" alt="Second slide" width="900" height="350">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/capteur.png')}}" alt="second slide" width="900" height="100">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/reseaux.png')}}" alt="third slide" width="700" height="250">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/sport3.jpg')}}" alt="Fourth slide" width="900" height="350">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/scanner2.jpg')}}" alt="Fifth slide" width="900" height="350">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/scanner1.jpg')}}" alt="Sixth slide" width="900" height="350">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{URL::asset('/images/bbbb.jpg')}}" alt="Seventh slide" width="900" height="350">
            </div>
            <div class="carousel-item">
